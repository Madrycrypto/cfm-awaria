...
// "operator" jest dopisany na koncu (nie wstawiony miedzy station/type), zeby
// nie przesunac kolumn i nie zepsuc juz zapisanych wierszy w istniejacych
// arkuszach — dziala tak samo dla nowego arkusza i dla juz uzywanego.
