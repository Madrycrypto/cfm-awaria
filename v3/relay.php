...
$WEBHOOK_REPORT  = 'https://ocn7yfudom36.jp.feishu.cn/base/workflow/webhook/event/ZrobapVv3wZ91VhphJ0joUwXpiQ'; // RaportDzienny
$WEBHOOK_QUALITY = 'https://ocn7yfudom36.jp.feishu.cn/base/workflow/webhook/event/OmoIaHIzewO2tYhvJLvj0TPQpBh'; // PrzyczynyJakosc
$WEBHOOK_AWARIA  = 'https://ocn7yfudom36.jp.feishu.cn/base/workflow/webhook/event/HL1taj5vdwhM8xhle7QjY9hgpHb'; // Awarie
$WEBHOOK_REWORK  = 'https://ocn7yfudom36.jp.feishu.cn/base/workflow/webhook/event/T5MQaNgSAweEFkhNmZMjckZhpig'; // ReworkProcessing
// ─────────────────────────────────────────────────────────────────────
...
if ($path === '/api/awaria' && $method === 'POST') {
    ...
    forward_to_feishu($WEBHOOK_AWARIA, [
        ...
        'operator' => isset($body['operator']) ? $body['operator'] : '',
